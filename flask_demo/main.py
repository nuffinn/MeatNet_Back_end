...
def submit():
	if(request.method == 'POST'):
            ...
            try:
                ...
                return {'error': f'{error_msg}'}, 400
            return {'result': f'{output}'}, 200
...
if __name__ == '__main__':
    ...
    model_path = "/home/starburst/Phteven/flask_demo/models/resnet50_ft.pth"
    trained_model.load_state_dict(torch.load(model_path, map_location=device))
    trained_model.to(device)
    app.run(threaded=True, port=9001)
